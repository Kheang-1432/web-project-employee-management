                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('employees.update', $employee->employee_id) }}">
                            @csrf
                            @method('PUT')
                            <!-- Form fields same as create but with existing values -->
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="department_id" name="department_id" required>
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->department_id }}" {{ (old('department_id', $employee->department_id) == $department->department_id) ? 'selected' : '' }}>
